        ...
        try {
            ...
            try {
                if (-not (Test-Path -Path $Path_PR)) {
                    ...
                    Write-EnhancedLog -Message "Directory already exists at $Path_PR" -Level "INFO" -ForegroundColor Yellow
                }
            } catch {
                Write-EnhancedLog -Message "An error occurred while creating directory at $Path_PR $_" -Level "ERROR" -ForegroundColor Red
            ...
            try {
                ...
                Write-EnhancedLog -Message "An error occurred while registering the scheduled task $schtaskName $_" -Level "ERROR" -ForegroundColor Red
                Handle-Error -ErrorRecord $_
                throw $_
            }
        } catch {
